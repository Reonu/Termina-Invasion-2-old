...
const LevelScript level_hmc_entry[] = {
	...
	AREA(3, hmc_area_3),
		...
		WARP_NODE(0xFA, LEVEL_BOB, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 1874, -1648, 6156, 0, 0, 0, 0x000A0000, bhvInstantActiveWarp),
		OBJECT(0x58, 2478, -1524, 4520, 0, 0, 0, 0x007F0000, bhvSnowball),
		OBJECT(0x58, 2796, -1528, 4481, 0, 0, 0, 0x00FF0000, bhvSnowball),
		TERRAIN(hmc_area_3_collision),
		MACRO_OBJECTS(hmc_area_3_Area_Root_Path_macro_objs),
