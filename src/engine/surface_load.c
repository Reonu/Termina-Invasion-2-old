...
static s32 surface_has_force(s16 surfaceType) {
    ...
    switch (surfaceType) {
        ...
        case SURFACE_WARP: //Termina Invasion: Added so that I can use the parameter in the warp collision type
            hasForce = TRUE;
            break;
...
void alloc_surface_pools(void) {
    sSurfacePoolSize = 6000;
    sSurfaceNodePool = main_pool_alloc(16000 * sizeof(struct SurfaceNode), MEMORY_POOL_LEFT);
